...
async def test_create_group_generates_slos(async_client: AsyncClient) -> None:
    ...
    resp = await async_client.get('/slo-definitions', params={'tag_key': 'slo_group', 'tag_val': 'grp1-group'})
...
async def test_update_group_add_row(async_client: AsyncClient) -> None:
    ...
    resp = await async_client.get('/slo-definitions', params={'tag_key': 'slo_group', 'tag_val': 'grp4-group'})
    assert resp.status_code == 200
...
async def test_update_group_remove_row(async_client: AsyncClient) -> None:
    ...
    resp = await async_client.get('/slo-definitions', params={'tag_key': 'slo_group', 'tag_val': 'grp5-group'})
    names = {item['name'] for item in resp.json()['items']}
...
async def test_extract_slo(async_client: AsyncClient) -> None:
    ...
    resp = await async_client.get('/slo-definitions', params={'tag_key': 'slo_group', 'tag_val': 'grp6-group'})
    names = {item['name'] for item in resp.json()['items']}
...
async def test_deactivate_group_cascades(async_client: AsyncClient) -> None:
    ...
    resp = await async_client.get('/slo-definitions', params={'tag_key': 'slo_group', 'tag_val': 'grp7-group'})

...
from tropek.db.models import Asset, DataSource, SLIDefinition, SLODefinition
...
class AssignmentReader(Protocol):
    ...
    async def resolve_for_asset(self, asset_id: uuid.UUID, group_ids: list[uuid.UUID]) -> list[ResolvedAssignment]:
